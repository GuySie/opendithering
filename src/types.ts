...
export const VIVID_PRESET: ProcessingSettings = {
  ...
  midpoint: 0.5,
  // dithering: Atkinson for high-contrast snap; OKLab distance for accurate hue matching
...
export const SOFT_PRESET: ProcessingSettings = {
  ...
  saturation: 1.1,
  contrast: 0.9,
  // dithering: Stucki spreads error wider for smoother gradients; reduced strength softens patterning
  ditherAlgorithm: 'stucki',
  errorSpace: 'oklab',
  distSpace: 'oklab',
  ditherStrength: 0.75,
  localVarianceDetection: true,
  expandPalette: false,
}
...
export const GRAYSCALE_PRESET: ProcessingSettings = {
  ...
  toneMode: 'contrast',
  contrast: 1.0,
  // dithering: full OKLab for best perceptual luminance matching in grayscale
