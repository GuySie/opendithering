...
A browser-based image dithering tool for e-paper displays. Runs entirely client-side using the Canvas API — no server, no uploads.
...
This whole thing was entirely vibecoded. I have not even looked at a single line. If you don't trust AI-written code, you probably should not run this.

## Features

- **Dithering algorithms** — To figure out what works best, we're trying classics like Floyd-Steinberg, Atkinson, Jarvis-Judice-Ninke, Stucki, Burkes and Sierra. But also more obscure or recent algorithms like Riemersma (Hilbert-curve), Blue noise (void and cluster), Yliluoma II, Dizzy, and Eschbach & Knox.
